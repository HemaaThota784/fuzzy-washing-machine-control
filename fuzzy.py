...
class enhanced_washing_machine:
    ...
    # Customize membership functions for laundry weight using gaussmf
    # gaussmf parameters: (universe, [sigma, mean])
       self.laundry_weight['very_light'] = fuzz.gaussmf(self.laundry_weight.universe, 0.8, 0.5)
       self.laundry_weight['light'] = fuzz.gaussmf(self.laundry_weight.universe, 0.8, 2.0)
       self.laundry_weight['medium'] = fuzz.gaussmf(self.laundry_weight.universe, 0.8, 4.0)
       self.laundry_weight['heavy'] = fuzz.gaussmf(self.laundry_weight.universe, 0.8, 6.0)
       self.laundry_weight['very_heavy'] = fuzz.gaussmf(self.laundry_weight.universe, 0.8, 7.5)
    
    # Customize membership functions for dirt level using gaussmf
       self.dirt_level['slightly_dirty'] = fuzz.gaussmf(self.dirt_level.universe, 1.0, 2.0)
       self.dirt_level['moderately_dirty'] = fuzz.gaussmf(self.dirt_level.universe, 1.2, 5.5)
       self.dirt_level['very_dirty'] = fuzz.gaussmf(self.dirt_level.universe, 1.0, 9.0)
    
    # Define membership functions for fabric type using gaussmf
    # 1: Delicate, 2: Wool, 3: Cotton, 4: Synthetic, 5: Heavy Duty
       self.fabric_type['delicate'] = fuzz.gaussmf(self.fabric_type.universe, 0.3, 1.0)
       self.fabric_type['wool'] = fuzz.gaussmf(self.fabric_type.universe, 0.3, 2.0)
       self.fabric_type['cotton'] = fuzz.gaussmf(self.fabric_type.universe, 0.4, 3.0)
       self.fabric_type['synthetic'] = fuzz.gaussmf(self.fabric_type.universe, 0.4, 4.0)
       self.fabric_type['heavy_duty'] = fuzz.gaussmf(self.fabric_type.universe, 0.3, 5.0)
    
    # Define membership functions for water hardness using gaussmf
       self.water_hardness['soft'] = fuzz.gaussmf(self.water_hardness.universe, 1.0, 2.0)
       self.water_hardness['medium'] = fuzz.gaussmf(self.water_hardness.universe, 1.0, 5.5)
       self.water_hardness['hard'] = fuzz.gaussmf(self.water_hardness.universe, 1.0, 9.0)
    
    # Define membership functions for powder required using gaussmf
       self.powder_required['very_low'] = fuzz.gaussmf(self.powder_required.universe, 4.0, 5.0)
       self.powder_required['low'] = fuzz.gaussmf(self.powder_required.universe, 4.0, 20.0)
       self.powder_required['medium'] = fuzz.gaussmf(self.powder_required.universe, 4.0, 35.0)
       self.powder_required['high'] = fuzz.gaussmf(self.powder_required.universe, 4.0, 50.0)
       self.powder_required['very_high'] = fuzz.gaussmf(self.powder_required.universe, 3.0, 60.0)
    
    # Define membership functions for wash time using gaussmf
       self.wash_time['very_short'] = fuzz.gaussmf(self.wash_time.universe, 5.0, 25.0)
       self.wash_time['short'] = fuzz.gaussmf(self.wash_time.universe, 8.0, 50.0)
       self.wash_time['medium'] = fuzz.gaussmf(self.wash_time.universe, 8.0, 75.0)
       self.wash_time['long'] = fuzz.gaussmf(self.wash_time.universe, 8.0, 100.0)
       self.wash_time['very_long'] = fuzz.gaussmf(self.wash_time.universe, 5.0, 115.0)
    
    # Define membership functions for water temperature using gaussmf
       self.water_temperature['cold'] = fuzz.gaussmf(self.water_temperature.universe, 4.0, 25.0)
       self.water_temperature['warm'] = fuzz.gaussmf(self.water_temperature.universe, 6.0, 45.0)
       self.water_temperature['hot'] = fuzz.gaussmf(self.water_temperature.universe, 6.0, 70.0)
       self.water_temperature['very_hot'] = fuzz.gaussmf(self.water_temperature.universe, 4.0, 85.0)
    
    # The rest of the function remains the same (rules definitions and control system setup)
    ...
    # Create control system
       self.washing_ctrl = ctrl.ControlSystem([rule1, rule2, rule3, rule4, rule5, rule6, rule7, rule8, rule9, rule10,
